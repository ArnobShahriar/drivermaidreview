...
<html lang="en">
  ...
  <body>
	...
	<a href="usersignin.php" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Sign Up AS Worker</a>
	<br>
	<br>
	<a href="admin.php" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Admin</a>
